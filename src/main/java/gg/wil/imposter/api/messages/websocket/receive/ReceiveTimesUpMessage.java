...
public class ReceiveTimesUpMessage extends WebSocketReceiveMessage {

    public ReceiveTimesUpMessage(Player from, JsonObject data) {
        super(WebSocketReceiveMessageType.TIMES_UP, from);
    }
}
