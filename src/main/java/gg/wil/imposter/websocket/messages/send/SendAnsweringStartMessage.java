...
public class SendAnsweringStartMessage extends WebSocketSendMessage {
    ...
    public SendAnsweringStartMessage(int roundNumber, int maxRounds, int time) {
        super(WebSocketSendMessageType.ANSWERING_START);
